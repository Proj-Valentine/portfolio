...
export const profileData: ProfileContent = {
  paragraphs: [
"I am Valentine Kwame Ampah, a dedicated professional with extensive </br> experience in data infrastructure and business strategy.<br /> Specializing in software development, data engineering, and automation, </br> I excel in team environments and committed to data-driven </br> excellence for growth and productivity."  ],
};
